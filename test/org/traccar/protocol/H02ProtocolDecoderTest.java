...
public class H02ProtocolDecoderTest extends ProtocolTest {
    ...
    public void testDecode() throws Exception {
        ...
        // Protocol used by tracker "Nancy"
        verifyPosition(decoder, binary(
                "2a48512c313630303037373533312c56312c3130333030352c412c343935332e333039302c4e2c30303833392e323331382c452c3030302e372c3231352e35302c3231303931372c302c464646464646464623"
        ));

        // Protocol used by tracker "Nancy"
        verifyPosition(decoder, buffer(
                "*HQ,1600077531,V1,095824,V,4953.3068,N,00839.2476,E,002.0,214.58,210917,0,FFFFFBFF#"
        ));
